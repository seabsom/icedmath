...
/**
 * Esta clase se encarga de mostrar el splashscreen con el logo del Tecnológico
 * de Monterrey
 * 
 ...
 * 
 */
public class PantallaGanador extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pantallaganaste);
		...
		Thread splashThread = new Thread() {
			...
			public void run() {
				try {
					...
					startActivity(new Intent(PantallaGanador.this, MadIce.class));
					finish();
					stop();
				}
			}
